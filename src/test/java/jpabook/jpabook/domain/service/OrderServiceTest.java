...
public class OrderServiceTest {
    ...
    public void 상품주문() {
        ...
        //book.setPrice(10000);  //int orderCount=2;
    ...
    private Book createBook(String name, int price, int stockQuantity) {        /** 원래 구체적으로 적혀있던 값을 파라미터로 빼기. Ctrl+Alt+p */
        Book book = new Book();
        book.setName(name);
        book.setPrice(price);
